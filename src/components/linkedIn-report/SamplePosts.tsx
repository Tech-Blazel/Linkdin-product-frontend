    ...
    <ReportCard title="Sample Posts" icon={FaChartLine}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        <div className="space-y-4">
          <a href="" target="_blank" className="text-linkedIn-primary">
            <div className="border rounded-xl shadow-sm p-4 text-sm space-y-2">
              ...
              <div className="text-gray-800 space-y-2 text-sm pt-2">
                <p>
                  The further I go in this work, the more convinced I become:
                </p>
                ...
                <p>
                  ...
                  fear—sometimes subtly, sometimes not. That fear ripples out.
                  It shows up in company politics. In second-guessing. In an
                  unspoken tension you can’t name, but you can definitely feel.
                </p>
          ...
          <a href="" target="_blank" className="text-linkedIn-primary">
            <div className="border rounded-xl shadow-sm p-4 text-sm space-y-2">
              ...
              <div className="text-gray-800 space-y-2 text-sm pt-2">
                <>
                  <p>
                    I used to think that building something great meant giving
                    up everything else.
                  </p>
                  ...
                  <p>
                    Because the truth is, when you spend years ignoring your
                    inner life, the cost isn’t just burnout. It’s subtle. It’s
                    corrosive. You lose your sense of self.
                  </p>

                  <p>
                    I’ve worked with founders who hit every external metric of
                    success and still felt like they were failing. Not because
                    the success wasn’t real—but because they were so
                    disconnected from themselves, they couldn’t feel it.
                  </p>
